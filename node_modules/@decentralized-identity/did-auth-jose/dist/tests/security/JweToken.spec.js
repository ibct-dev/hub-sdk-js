...
describe('JweToken', () => {
    ...
    describe('constructor', () => {
        ...
        it('should parse a JSON JWE from a string', () => __awaiter(this, void 0, void 0, function* () {
    ...
    describe('encrypt', () => {
        ...
        it('should call the crypto Algorithms\'s encrypt', () => __awaiter(this, void 0, void 0, function* () {
            crypto.reset();
            const jwk = {
                kty: 'RSA',
                kid: 'test',
        ...
        it('should accept additional headers', () => __awaiter(this, void 0, void 0, function* () {
            const jwk = {
                kty: 'RSA',
                kid: 'test',
                defaultEncryptionAlgorithm: 'test',
    ...
    describe('encryptAsFlattenedJson', () => {
        ...
        it('should accept additional options', () => __awaiter(this, void 0, void 0, function* () {
            const jwk = {
                kty: 'RSA',
                kid: 'test',
                defaultEncryptionAlgorithm: 'test',
    ...
    describe('decrypt', () => {
        ...
        it('should fail for an unsupported encryption algorithm', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should require headers', () => __awaiter(this, void 0, void 0, function* () {
            const newMessage = usingheaders({
                kty: 'test',
                kid: privateKey.kid,
                enc: 'test'
        ...
        it('should check "crit" per RFC 7516 5.2.5 and RFC 7515 4.1.11', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should require the key ids to match', () => __awaiter(this, void 0, void 0, function* () {
            const newMessage = usingheaders({
                kty: 'test',
        ...
        it('should decrypt compact JWEs', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should decrypt flattened JSON JWEs', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should decrypt flattened JSON JWEs using aad', () => __awaiter(this, void 0, void 0, function* () {
            const pub = privateKey.getPublicKey();
        ...
        it('should require the JWE to have been parsed correctly', () => __awaiter(this, void 0, void 0, function* () {
    ...
    describe('validations', () => {
        describe('RSAES-OAEP with AES GCM', () => {
            ...
            it('should decrypt correctly', () => __awaiter(this, void 0, void 0, function* () {
                const parsedJwe = new lib_1.JweToken(JWE, registry);
                const actualPlaintext = yield parsedJwe.decrypt(rsaKey);
                expect(actualPlaintext).toEqual(plaintext.toString());
            }));
            it('should encrypt correctly', (done) => __awaiter(this, void 0, void 0, function* () {
