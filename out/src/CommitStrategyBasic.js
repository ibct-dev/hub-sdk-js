...
class CommitStrategyBasic {
    ...
    compareCommits(a, b) {
        ...
        if (aHeaders.operation === 'create')
            return -1;
        if (bHeaders.operation === 'create')
            return 1;
        if (aHeaders.operation === 'delete')
            return 1;
        if (bHeaders.operation === 'delete')
            return -1;
...
exports.default = CommitStrategyBasic;
//# sourceMappingURL=CommitStrategyBasic.js.map